...
src_configure() {
	...
	if tc-is-cross-compiler ; then
		sed -i -e "s|set(AM_QT_MOC_EXECUTABLE.*|set(AM_QT_MOC_EXECUTABLE \"/usr/lib64/qt5/bin/moc\")|" ${WORKDIR}/${P}_build/src/CMakeFiles/gqrx_autogen.dir/AutogenInfo.cmake || die
		sed -i -e "s|/usr/${CHOST}/usr/lib64/qt5/bin/rcc|/usr/lib64/qt5/bin/rcc|" -e "s|/usr/${CHOST}/usr/lib64/qt5/bin/uic|/usr/lib64/qt5/bin/uic|" ${WORKDIR}/${P}_build/src/CMakeFiles/gqrx.dir/build.make || die
	fi
}
