...
src_configure() {
	...
	if tc-is-cross-compiler ; then
		sed -i -e "s|usr/${CHOST}/usr/lib64|usr/lib64|" ${WORKDIR}/${P}_build/gr-qtgui/lib/CMakeFiles/gnuradio-qtgui.dir/build.make || die
		sed -i -e "s|usr/${CHOST}/usr/lib64|usr/lib64|" ${WORKDIR}/${P}_build/gr-qtgui/examples/c++/CMakeFiles/display_qt.dir/build.make || die
	fi
}
