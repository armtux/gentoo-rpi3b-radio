...
IUSE="${IUSE} dbus debug neon pulseaudio selinux startup-notification system-harfbuzz
 system-icu system-jpeg system-libevent system-sqlite system-libvpx wayland"
...
RDEPEND=">=app-text/hunspell-1.5.4:=
	dev-libs/atk
	dev-libs/expat
	!wayland? ( >=x11-libs/cairo-1.10[X] )
	wayland? ( >=x11-libs/cairo-1.10 )
	x11-libs/gdk-pixbuf
	...
	virtual/ffmpeg
	!wayland? ( x11-libs/libX11 )
	!wayland? ( x11-libs/libXcomposite )
	!wayland? ( x11-libs/libXdamage )
	!wayland? ( x11-libs/libXext )
	!wayland? ( x11-libs/libXfixes )
	!wayland? ( x11-libs/libXrender )
	!wayland? ( x11-libs/libXt )
